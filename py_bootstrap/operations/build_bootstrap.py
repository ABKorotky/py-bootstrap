...
class DefaultBuildBootstrapOperation(BaseBuildBootstrapOperation):
    ...
    def build_context(self) -> dict[str, str]:
        ...
        ctx["name"] = name
        ctx["python_name"] = python_name
        ctx["upper_name"] = upper_name
        ctx["class_name"] = class_name
        ctx["title"] = title
        ctx["description"] = self.cli_namespace.description.strip()
